#!/usr/bin/env bash
# verl GRPO v12 training: 纯 JSON 输出 prompt + JSON 解析 reward
# 起点: Qwen2.5-0.5B-Instruct base (跳过 SFT)
# 训练量: 2 epoch × 762 steps/epoch = 1524 total steps
# 保存: 每 300 步 (epoch 1: 300/600/900/1200/1500, epoch 2: 1800/2100/2400/2700/3000)
...
# v12 奖励
REWARD_PATH="${ROOT}/train_pipeline/reward_chaingsm_v12_json_verl.py"
