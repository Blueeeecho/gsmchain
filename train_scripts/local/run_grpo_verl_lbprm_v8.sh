...
CHAIN_TO_ANSWER_CHECK_WEIGHT="${CHAIN_TO_ANSWER_CHECK_WEIGHT:-0.20}"
TARGET_RECOGNITION_WEIGHT="${TARGET_RECOGNITION_WEIGHT:-0.15}"
CHAIN_LENGTH_CONSISTENCY_WEIGHT="${CHAIN_LENGTH_CONSISTENCY_WEIGHT:-0.05}"
IRRELEVANT_EQ_PENALTY_WEIGHT="${IRRELEVANT_EQ_PENALTY_WEIGHT:-0.30}"
