...
# VERSION=v12 pre-set. All real logic lives in submit_grpo_verl_vllm.sh.
#
# Prefer calling submit_grpo_verl_vllm.sh directly with --version v12 (or
...
exec "${SCRIPT_DIR}/submit_grpo_verl_vllm.sh" --version "v12" "$@"
